            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="/category">List</a></li>
                        <li class="nav-item"> <a class="nav-link" href="/admin/category/add">Add</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#ui-basic-or" aria-expanded="false" aria-controls="ui-basic-or">
                    <i class="icon-layout menu-icon"></i>
